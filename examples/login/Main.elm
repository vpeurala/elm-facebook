...
update action model =
    ...
    case action of
        ...
        FacebookResponse (Facebook.Did (Facebook.Login)) ->
            let
                requestUserInfo =
                    FacebookRequest (Facebook.GET "me")
            in
...
facebookLoginView address { facebook, name } =
    div []
        ...
        , case facebook.id of
            Nothing ->
                button [ onClick (Signal.forwardTo address FacebookRequest) Facebook.Login ]
            ...
            Just id ->
                div []
                    ...
                    , button [ onClick (Signal.forwardTo address FacebookRequest) Facebook.Logout ]
                        [ text "Logout" ]
                    ]
        ]
